...
import type { AgentNodeSummary, AgentNode } from '../types/brain';
import {
  Table,
  TableBody,
  TableCell,
  ...
  if (nodes.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-muted-foreground">No agent nodes are currently registered with the Brain server.</p>
      </div>
    );
  }
