            ...
            {virtualItems.map((virtualRow) => {
              ...
              return (
                ...
                >
                  <div
                    className={cn(
                      "grid h-full items-center content-center px-4 transition-all duration-200 border-l-2 border-transparent",
                      "hover:bg-muted/30 hover:border-l-accent-primary/40",
